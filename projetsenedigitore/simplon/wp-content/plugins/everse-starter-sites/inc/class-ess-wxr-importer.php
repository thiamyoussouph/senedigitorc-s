...
// Include files.
require ESS_DIR_PATH . 'inc/importer/class-wxr-importer.php';

class ESS_WXR_Importer extends ESS_HM_WXR_Importer {
	...
	/**
	 * Get all protected variables from the ESS_HM_WXR_Importer needed for continuing the import.
	 */
	...
	/**
	 * Sets all protected variables from the ESS_HM_WXR_Importer needed for continuing the import.
	 *
