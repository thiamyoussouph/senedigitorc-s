...
// Include files.
require ESS_DIR_PATH . 'inc/importer/class-logger.php';
require ESS_DIR_PATH . 'inc/importer/class-logger-cli.php';

class ESS_Logger extends ESS_HM_WP_Importer_Logger_CLI {
